...
const LockedStakingApy: React.FC<React.PropsWithChildren<LockedStakingApyProps>> = ({
  ...
  const earningTokenBalance = useMemo(() => {
    return getBalanceNumber(currentLockedAmountAsBigNumber.minus(userData?.shdwAtLastUserAction))
  }, [currentLockedAmountAsBigNumber, userData?.shdwAtLastUserAction])

...
const PerpetualBanner = () => {
  ...
  return (
    <S.Wrapper>
      <S.Inner>
        <S.LeftWrapper>
          <S.StyledSubheading ref={headerRef}>{t('Woof Lab')}</S.StyledSubheading>
          <Header width={['160px', '160px', 'auto']}>{t('Powered by Woof Lab')}</Header>
        ...
        <RightWrapper>
          {isDesktop ? (
            <Image src={wooflabImage} alt="PerpetualBanner" width={392} height={232} placeholder="blur" />
          ) : (
            <Image src={wooflabImage} alt="PerpetualBanner" width={208} height={208} placeholder="blur" />
          )}
        </RightWrapper>
      </S.Inner>
    </S.Wrapper>

...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label = currency === bscTokens.wbnb ? t('Max. WCORE entry') : t('Max. token entry')
  ...
  const basicTooltipContent = t(
    'For the private sale, each eligible participant will be able to commit any amount of WCORE up to the maximum commit limit, which is published along with the IFO voting proposal/information.',
  )
      ...
      <ModalBody maxWidth="360px">
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough WCORE, you may not receive a meaningful amount of IFO tokens, or you may not receive any IFO tokens at all.',
            )}
            <Link
              fontSize="12px"
              display="inline"
              href="https://shadow-11.gitbook.io/shadowswap/products/ifo-initial-farm-offering"
              external
            >
              {t('Read more')}
            </Link>

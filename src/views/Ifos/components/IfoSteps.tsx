...
const Step1 = () => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      <Text>
        {t(
          'The number of iSHDW equals the locked staking amount if the staking duration is longer than %weeks% weeks. If the staking duration is less than %weeks% weeks, it will linearly decrease based on the staking duration.',
          {
            weeks: weeksDisplay,
          },
        )}
      </Text>
      <InlineLink external href="https://shadow-11.gitbook.io/shadowswap/products/ifo-initial-farm-offering">
        {t('Learn more about iSHDW')}
      </InlineLink>
    </Box>,
    {},
  )
    ...
    <CardBody>
      ...
      <Box>
        ...
        <TooltipText as="span" fontWeight={700} ref={targetRef} color="textSubtle" small>
          {t('How does the number of iSHDW calculated?')}
        </TooltipText>
